...
# Function to classify gene expression using GMM
...
def main():
    ...
    main_path = "/mnt/nsong-data-disk/Craig_Spatial/Craig_SPA6_A/outs"
    subfolder = "Spatial_enrichment_classifier"
    path = os.path.join(main_path, subfolder)
    WSI_path = os.path.join(main_path, "Craig_SPA6_A.tif")
    radius = 90
    ...
    enrichment_csv = os.path.join(path, "Spatial_Enrichment.csv")
    ...
    for gene_name in top_ten_genes:
        ...
        # Step 1: Extract gene expression data and apply GMM classification
        ...
        gene_labels = classify_gene_expression_gmm(gene_expression)
        ...
        output_path = os.path.join(gene_folder, f"{gene_name}_labeled_exp.csv")
        ...
        metadata_path = os.path.join(gene_folder, "meta.csv")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            output_dir = os.path.join(gene_folder, f"{gene_name}_embeddings")
